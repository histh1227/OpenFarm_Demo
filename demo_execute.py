...
본 웹사이트는 Streamlit Community Cloud 환경에서 호스팅되고 있습니다.
제한된 서버 자원으로 인해 이용 시 분석 버튼은 한 분씩 차례대로 눌러주세요!
   - YOLO AI 모델을 구동하기 때문에, 여러 명이 동시에 '🚀 AI 자율 분석 및 제어 실행' 버튼을 누르면 서버가 다운될 수 있습니다😢​
   - 원활한 테스트를 위해 앞 사람의 분석이 끝난 후 약간의 시간차를 두고 버튼을 클릭해주세요!
